...
2. **Load flow state.** Read `.sdf/flows/<flow-name>/STATE.md`. Verify the flow has reached at least Stage 10.

3. **Load context.** Read:
   - `.sdf/flows/<flow-name>/PLAN_<flow-name>.md` -- to understand what was built and which files are involved
